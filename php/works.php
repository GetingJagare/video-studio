...
$works = [
    ['/^\/works\/1\/.*$/', [
        'en' => [
            ...
            'videoFiles' => [
                ['src' => '/img/videos/VcP0OsEq2n4.mp4', 'type' => 'video/mp4']],
            'posterImage' => '/img/teasers/VcP0OsEq2n4.jpg',
            'hashTags' => [
                ['tag' => 'hashtag #1-1', 'url' => '#'],
                ['tag' => 'hashtag #1-2', 'url' => '#'],
                ['tag' => 'hashtag #1-3', 'url' => '#'],
    ...
    ['/^\/works\/2\/.*$/', [
        'en' => [
            ...
            'videoFiles' => [
                ['src' => '/img/videos/XgFcBiVepv8.mp4', 'type' => 'video/mp4']],
            'posterImage' => '/img/teasers/XgFcBiVepv8.jpg',
            'hashTags' => [
                ['tag' => 'hashtag #2-1', 'url' => '#'],
                ['tag' => 'hashtag #2-2', 'url' => '#'],
                ['tag' => 'hashtag #2-3', 'url' => '#'],
    ...
    ['/^\/works\/3\/.*$/', [
        'en' => [
            ...
            'videoFiles' => [
                ['src' => '/img/videos/gfcOmEbXDVo.mp4', 'type' => 'video/mp4']],
            'posterImage' => '/img/teasers/gfcOmEbXDVo.jpg',
            'hashTags' => [
                ['tag' => 'hashtag #3-1', 'url' => '#'],
                ['tag' => 'hashtag #3-2', 'url' => '#'],
                ['tag' => 'hashtag #3-3', 'url' => '#'],
    ...
    ['/^\/works\/4\/.*$/', [
        'en' => [
            ...
            'videoFiles' => [
                ['src' => '/img/videos/2WxRax5wvXc.mp4', 'type' => 'video/mp4']],
            'posterImage' => '/img/teasers/2WxRax5wvXc.jpg',
            'hashTags' => [
                ['tag' => 'hashtag #4-1', 'url' => '#'],
                ['tag' => 'hashtag #4-2', 'url' => '#'],
                ['tag' => 'hashtag #4-3', 'url' => '#'],
    ...
    ['/^\/works\/5\/.*$/', [
        'en' => [
            ...
            'videoFiles' => [
                ['src' => '/img/videos/WGJUwa2TJT0.mp4', 'type' => 'video/mp4']],
            'posterImage' => '/img/teasers/WGJUwa2TJT0.jpg',
            'hashTags' => [
                ['tag' => 'hashtag #5-1', 'url' => '#'],
                ['tag' => 'hashtag #5-2', 'url' => '#'],
                ['tag' => 'hashtag #5-3', 'url' => '#'],
    ...
    ['/^\/works\/6\/.*$/', [
        'en' => [
            ...
            'videoFiles' => [
                ['src' => '/img/videos/du0ufTM5FQs.mp4', 'type' => 'video/mp4']],
            'posterImage' => '/img/teasers/du0ufTM5FQs.jpg',
            'hashTags' => [
                ['tag' => 'hashtag #6-1', 'url' => '#'],
                ['tag' => 'hashtag #6-2', 'url' => '#'],
                ['tag' => 'hashtag #6-3', 'url' => '#'],
    ...
    ['/^\/works\/7\/.*$/', [
        'en' => [
            ...
            'videoFiles' => [
                ['src' => '/img/videos/WBaCTiGrZeU.mp4', 'type' => 'video/mp4']],
            'posterImage' => '/img/teasers/WBaCTiGrZeU.jpg',
            'hashTags' => [
                ['tag' => 'hashtag #7-1', 'url' => '#'],
                ['tag' => 'hashtag #7-2', 'url' => '#'],
                ['tag' => 'hashtag #7-3', 'url' => '#'],
    ...
    ['/^\/works\/8\/.*$/', [
        'en' => [
            ...
            'videoFiles' => [
                ['src' => '/img/videos/QgF764UVM44.mp4', 'type' => 'video/mp4']],
            'posterImage' => '/img/teasers/QgF764UVM44.jpg',
            'hashTags' => [
                ['tag' => 'hashtag #8-1', 'url' => '#'],
                ['tag' => 'hashtag #8-2', 'url' => '#'],
                ['tag' => 'hashtag #8-3', 'url' => '#'],
    ...
    ['/^\/works\/9\/.*$/', [
        'en' => [
            ...
            'videoFiles' => [
                ['src' => '/img/videos/N2e1OTEkI6Y.mp4', 'type' => 'video/mp4']],
            'posterImage' => '/img/teasers/N2e1OTEkI6Y.jpg',
            'hashTags' => [
                ['tag' => 'hashtag #9-1', 'url' => '#'],
                ['tag' => 'hashtag #9-2', 'url' => '#'],
                ['tag' => 'hashtag #9-3', 'url' => '#'],
